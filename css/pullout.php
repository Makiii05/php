...
<div class="container">
    <div class="left-div">
        <div class="content">
        <h2 class="heading">Pull Out Form</h2>
            <form action="ledger.php" method="get">
                    <input placeholder="Date" type="date" name="txtdate" value="<?PHP echo date('Y-m-d')?>"><br>
                    <select aria-placeholder="Product Name" name="txtproduct" required>
                        <?PHP
    ...
    <div class="right-div">
        <div class="content">
        <h2 class="heading">Pull Out History</h2>
        <?PHP
            $conn = new mysqli("localhost", "root", "" ,"dbprelim");   
