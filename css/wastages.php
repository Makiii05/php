...
<div class="container">
    <div class="left-div">
        <div class="content">
        <h2 class="heading">Wastages Form</h2>
            <form action="ledger.php" method="get">
                <input type="date"  name="txtdate" value="<?PHP echo date('Y-m-d') ?>"><br>
                <input placeholder="Waste Number" type="number" name="txtwaste"><br>
    ...
    <div class="right-div">
        <div class="content">
        <h2 class="heading">Wastages History</h2>
